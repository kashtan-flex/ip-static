...
Версия: tilda-lead-bridge-js-089-success-period
...
- текст success-сообщения обновлён: «Спасибо, я скоро с Вами свяжусь.»
- success-текст выровнен по центру в desktop и mobile, время отображения 4.2s сохранено.
- обращение «Вами» написано с большой буквы в кастомном success-сообщении.
- добавлена точка в конце кастомного success-сообщения.
